...
//LOGIN MEMAKAI AKUNMU
//TERUS DIPOJOK KANAN ATAS ADA MyAPI KEYS di klik
//TERUS DI KEYS ADA TOKENNYA ITU DI SALIN 
//SETELAH ITUUUUU TEMPEL DI  "GANTI DENGAN APIMU" ATAU DI BARIS 14 
//SEKIAANNNNNNNNNNNNNN
const char* ssid = "Wokwi-GUEST";
const char* password = "";
String apiKey = "b05b6f085638df8979c07cb9816bfd43"; //GANTI DISINIIIIIIIIII
String city = "Malang";
String units = "metric";
